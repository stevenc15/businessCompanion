/**
 * googleSigninContainer - layout component for google sign-in component 
 * for functionality, represents google sign-in button
 * 
 * Additionally, utilizes custom google sign-in hook
 */

import googleLogin from '../hooks/googleSignin';    
