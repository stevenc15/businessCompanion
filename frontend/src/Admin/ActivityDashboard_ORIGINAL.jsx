...
function ActivityDashboard() {
  ...
  }, []); // No dependencies for now, END OF FETCH ACTIVITIES CONST
  */}


  {/*
  //to be called when activities is populated, once, ALSO REMOVE FOR EXCEL FILE DISPLAY
  useEffect(() => {     
      fetchActivities();
  }, [fetchActivities]);
